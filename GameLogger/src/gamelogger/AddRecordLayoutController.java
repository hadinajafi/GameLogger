/**
 * This class is controller for AddrecordLayout.fxml
 * The UI contains contains Grid Pane and one HBox
 * Grid Pane contains ComboBox, Spinner, DatePicker
 * HBox contains two cancel and OK buttons.
*/
package gamelogger;
